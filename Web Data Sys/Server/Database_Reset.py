...
CREATEQUERY = ("CREATE TABLE Users ( User_ID BIGINT UNSIGNED UNIQUE AUTO_INCREMENT, User_Name VARCHAR(50), Password VARCHAR(100), Password_Salt VARCHAR(50), PhoneNum VARCHAR(50) UNIQUE, PRIMARY KEY (User_Name));")
