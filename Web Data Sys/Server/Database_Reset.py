...
CREATEQUERY = ("CREATE TABLE Users ( User_ID BIGINT UNSIGNED UNIQUE, User_Name VARCHAR(50), Password VARCHAR(100), Password_Salt VARCHAR(50) UNIQUE, PhoneNum VARCHAR(50) UNIQUE, PRIMARY KEY (User_Name));")
