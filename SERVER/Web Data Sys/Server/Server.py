...
import urllib.parse
from Server_utli import UrlParse, Log_In, Sign_Up, Sign_Up_Send_Verify_Code, Change_Password_Send_Verify_Code, Change_Password, Get_User_Info, Get_All_Products, Get_Shopping_Cart, Add_To_Shopping_Cart, Add_To_Favorite_Product, Get_User_Profile, Get_Favorite_Product, Get_All_Messages
...
class MyNewhandler(BaseHTTPRequestHandler):
    ...
    def do_GET(self):
        ...
        elif URL_PATH == '/get_all_messages':
            URL_QUERY = UrlParse_Res['query']

            USER_ID = URL_QUERY['User_ID'][0]

            (STATUS_CODE, DATA) = Get_All_Messages(USER_ID)
