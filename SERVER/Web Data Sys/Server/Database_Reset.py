...
ADD_PRODUCT1 = ("INSERT INTO Products(Products_ID, Products_Name, Products_Number, Products_Spec, Products_Color, Products_Status, Products_Price, Products_Image_Dir) VALUE (\'{}\', 'GB846-85', 'P8847384', '32X32', '黑色', 0, 5000, 'Product_1');".format(PRODUCT1))
ADD_PRODUCT2 = ("INSERT INTO Products(Products_ID, Products_Name, Products_Number, Products_Spec, Products_Color, Products_Status, Products_Price, Products_Image_Dir) VALUE (\'{}\', 'G8465', 'P8847384','8X15', '本色', 1, 3234, 'Product_1');".format(PRODUCT2))
ADD_PRODUCT3 = ("INSERT INTO Products(Products_ID, Products_Name, Products_Number, Products_Spec, Products_Color, Products_Status, Products_Price, Products_Image_Dir) VALUE (\'{}\', 'GB84-88', 'P8834484','3X25', '灰色', 1, 4323, 'Product_1');".format(PRODUCT3))
ADD_PRODUCT4 = ("INSERT INTO Products(Products_ID, Products_Name, Products_Number, Products_Spec, Products_Color, Products_Status, Products_Price, Products_Image_Dir) VALUE (\'{}\', 'GB846-82', 'P5547384','32X12', '黄色', 1, 1232, 'Product_1');".format(PRODUCT4))
ADD_PRODUCT5 = ("INSERT INTO Products(Products_ID, Products_Name, Products_Number, Products_Spec, Products_Color, Products_Status, Products_Price, Products_Image_Dir) VALUE (\'{}\', 'GB846-83', 'P8823484','33X33', '黑色', 0, 12311, 'Product_1');".format(PRODUCT5))
ADD_PRODUCT6 = ("INSERT INTO Products(Products_ID, Products_Name, Products_Number, Products_Spec, Products_Color, Products_Status, Products_Price, Products_Image_Dir) VALUE (\'{}\', 'GB846-85', 'P8543484','32X55', '黑色', 1, 23323, 'Product_1');".format(PRODUCT6))
ADD_PRODUCT7 = ("INSERT INTO Products(Products_ID, Products_Name, Products_Number, Products_Spec, Products_Color, Products_Status, Products_Price, Products_Image_Dir) VALUE (\'{}\', 'GB846-85', 'P8865684','45X65', '本色', 0, 5656, 'Product_1');".format(PRODUCT7))
...
ADD_PRODUCT8 = ("INSERT INTO Products(Products_ID, Products_Name, Products_Number, Products_Spec, Products_Color, Products_Status, Products_Price, Products_Image_Dir) VALUE (\'{}\', 'GB846-85', 'P8847324', '32X32', '黑色', 0, 5000, 'Product_1');".format(PRODUCT8))
ADD_PRODUCT9 = ("INSERT INTO Products(Products_ID, Products_Name, Products_Number, Products_Spec, Products_Color, Products_Status, Products_Price, Products_Image_Dir) VALUE (\'{}\', 'G8465', 'P8847383','8X1', '本色', 1, 3134, 'Product_1');".format(PRODUCT9))
ADD_PRODUCT10 = ("INSERT INTO Products(Products_ID, Products_Name, Products_Number, Products_Spec, Products_Color, Products_Status, Products_Price, Products_Image_Dir) VALUE (\'{}\', 'GB84-88', 'P8835484','3X2', '灰色', 1, 4323, 'Product_1');".format(PRODUCT10))
ADD_PRODUCT11 = ("INSERT INTO Products(Products_ID, Products_Name, Products_Number, Products_Spec, Products_Color, Products_Status, Products_Price, Products_Image_Dir) VALUE (\'{}\', 'GB846-82', 'P5587384','32X2', '黄色', 1, 1332, 'Product_1');".format(PRODUCT11))
ADD_PRODUCT12 = ("INSERT INTO Products(Products_ID, Products_Name, Products_Number, Products_Spec, Products_Color, Products_Status, Products_Price, Products_Image_Dir) VALUE (\'{}\', 'GB846-83', 'P8826484','3X33', '黑色', 0, 15311, 'Product_1');".format(PRODUCT12))
ADD_PRODUCT13 = ("INSERT INTO Products(Products_ID, Products_Name, Products_Number, Products_Spec, Products_Color, Products_Status, Products_Price, Products_Image_Dir) VALUE (\'{}\', 'GB846-85', 'P8547484','32', '黑色', 1, 23323, 'Product_1');".format(PRODUCT13))
ADD_PRODUCT14 = ("INSERT INTO Products(Products_ID, Products_Name, Products_Number, Products_Spec, Products_Color, Products_Status, Products_Price, Products_Image_Dir) VALUE (\'{}\', 'GB846-85', 'P8855684','65', '本色', 0, 6656, 'Product_1');".format(PRODUCT14))
