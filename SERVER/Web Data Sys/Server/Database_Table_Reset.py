...
CREATE_ADDRESS = ("CREATE TABLE IF NOT EXISTS Address ( Address_ID VARCHAR(100) UNIQUE, Street VARCHAR(100), City VARCHAR(100), Province VARCHAR(100), Post_Code VARCHAR(100), PRIMARY KEY (Address_ID));")
...
CREATE_ORDERS = ("CREATE TABLE IF NOT EXISTS Orders ( Order_ID VARCHAR(100) UNIQUE, Order_Status INT, Order_Time DATETIME, Order_Shipping_Address_ID  VARCHAR(100), PRIMARY KEY (Order_ID), FOREIGN KEY (Order_Shipping_Address_ID) REFERENCES Address(Address_ID));")
...
CREATE_PRODUCT = ("CREATE TABLE IF NOT EXISTS Products ( Products_ID VARCHAR(100) UNIQUE, Products_Status INT, Products_Spec VARCHAR(100), Products_Price BIGINT UNSIGNED, PRIMARY KEY (Products_ID));")

CREATE_ORDERS_PRODUCTS = ("CREATE TABLE IF NOT EXISTS Orders_Products ( Order_ID VARCHAR(100), Products_ID VARCHAR(100), Products_Units BIGINT UNSIGNED, PRIMARY KEY (Order_ID, Products_ID), FOREIGN KEY (Products_ID) REFERENCES Products(Products_ID), FOREIGN KEY (Order_ID) REFERENCES Orders(Order_ID));")
