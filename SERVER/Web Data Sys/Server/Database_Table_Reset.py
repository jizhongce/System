...
CREATE_USER = ("CREATE TABLE IF NOT EXISTS Users ( User_ID VARCHAR(100) UNIQUE, User_Name VARCHAR(50), Password VARCHAR(100), PhoneNum VARCHAR(50) UNIQUE, Verified BOOLEAN, TEMPCODE BIGINT UNSIGNED, PRIMARY KEY (User_ID), FOREIGN KEY (PhoneNum) REFERENCES Phone_Numner_Verify_Code(Phone_Number) );")
