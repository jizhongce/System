...
CREATE_ADDRESS = ("CREATE TABLE IF NOT EXISTS Address ( Address_ID VARCHAR(100) UNIQUE, Address_Name VARCHAR(100), Address_Phone_Number VARCHAR(50), Street VARCHAR(100), City VARCHAR(100), Province VARCHAR(100), Post_Code VARCHAR(100), PRIMARY KEY (Address_ID));")
